...
func (m *Worker) GetCurrentThreadId() string {
	if m != nil {
		return m.CurrentThreadId
	}
	return ""
}
...
var fileDescriptor_48dc248d3c391ada = []byte{
	...
	,
}
...
func (m *Worker) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CurrentThreadId) > 0 {
		i -= len(m.CurrentThreadId)
		copy(dAtA[i:], m.CurrentThreadId)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.CurrentThreadId)))
		i--
		dAtA[i] = 0x32
	}
...
func (m *Worker) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CurrentThreadId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CurrentThreadId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
