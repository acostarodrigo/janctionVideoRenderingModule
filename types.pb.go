...
func (m *VideoRenderingThread_Solution) GetFiles() map[string]string {
	if m != nil {
		return m.Files
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "janction.videoRendering.v1.VideoRenderingThread.Solution.FilesEntry")
...
var fileDescriptor_48dc248d3c391ada = []byte{
	...
	,
}
